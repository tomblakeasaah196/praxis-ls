...
<body>
   ...
   <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="adminMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin5" class="accordion-collapse collapse show" data-bs-parent="#adminMenu">
                <div class="sub-menu">
  ...
  <script>
    ...
    const COST_ITEMS = [
      "Brokerage Fees",       // Replaces Manifest Release
      "Caution",
      "Customs Clearance",    // Replaces Clearance
      "Demurrage",
      "Destination Fees",
      "Detention",
      "Endorsement",
      "Freight Cost",
      "Port Charges",         // NEW
      "Scanning Fees",        // Replaces Transfer to ICD
      "Shipping Line Charges",// NEW
      "Staff Transportation", // NEW
      "Storage",
      "Transport",
      "Yard Occupancy"        // Fixed Spelling
    ];
