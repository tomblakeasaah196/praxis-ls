...
if (isset($_GET['ajax'])) {
  ...
  if ($ajax === 'po_approve') {
    ...
    if (!in_array($roleNow, ['ADMIN','FINANCE'], true)) {
...
<body>
  ...
  <script>
    ...
    async function reloadList(){
      ...
      tbody.innerHTML = '';
      const canFinanceApprove = ['ADMIN','FINANCE'].includes(String(USER_ROLE || '').toUpperCase());
