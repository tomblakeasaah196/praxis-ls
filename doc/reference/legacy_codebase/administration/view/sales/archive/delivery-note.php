          ...
          <div class="mb-3">
            ...
            <div class="row g-1">
              ...
              <div class="col-md-8">
                ...
                <input type="text" id="inp-client-addr" class="form-control smart-input" placeholder="Street Address" readonly>
              </div>
              <div class="col-md-4">
                <label class="form-label">City / Zone</label>
                <input type="text" id="inp-client-city" class="form-control smart-input" readonly>
              </div>

              <div class="col-md-6">
                <label class="form-label">Contact</label>
                <input type="text" id="inp-client-contact" class="form-control smart-input" placeholder="Attn:" readonly>
              </div>
              <div class="col-md-6">
                <label class="form-label">Phone</label>
                <input type="text" id="inp-client-phone" class="form-control smart-input" readonly>
              </div>
            </div>
          </div>
        ...
        <div class="card-custom h-100 bg-white p-0 overflow-hidden">
          ...
          <div class="p-3">
            ...
            <div class="mb-2">
              ...
              <input type="date" id="inp-date" class="form-control smart-input" readonly>
            </div>
