  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="salesMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="sales3" class="accordion-collapse collapse show" data-bs-parent="#salesMenu">
                <div class="sub-menu">
...
<div class="top-navbar">
  ...
  <!-- Drawer (unchanged) -->
  <div class="offcanvas offcanvas-end" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" id="oppDrawer" style="width: 850px;">
