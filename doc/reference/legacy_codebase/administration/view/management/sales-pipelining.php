 ...
 <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="mgmtMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="mgmt2" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
                <div class="sub-menu">
                    ...
                    <a href="sales-pipelining.php" class="sub-link active">Sales Pipeline</a>
  ...
  <!-- TOP BAR (FROM index.php) -->
  <div class="top-navbar">
    <div>
      <h5 class="mb-0 fw-bold text-dark">Sales Funnel</h5>
      <small class="text-muted" style="font-size: 0.7rem;">MANAGEMENT SALES CONVERSION</small>
    </div>
    ...
    <div id="moduleShell" class="py-4">
      ...
      <div class="d-flex justify-content-between align-items-end mb-4">
        ...
        <div class="d-flex gap-2">
          ...
          <button onclick="openDrawer('create')" id="btnNewOpp" class="btn btn-smart-orange fw-bold shadow-sm text-white d-none">
    ...
    <div class="offcanvas-body p-0 bg-white">
      ...
      <div class="p-4 border-top sticky-bottom bg-white d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-2" id="actionButtons">
          ...
          <button type="button" class="btn btn-primary fw-bold d-none" onclick="saveOpp()">Save Changes</button>
        </div>
      </div>
  ...
  async function refreshPipeline() {
    ...
    // MAPPING LOGIC: We must explicitly copy 'ref' so it's available for the cards
    opportunities = data.map(o => ({
      id: o.id,
      ref: o.ref || '',                   // <--- ADD THIS LINE
        ...
        cardsHtml += `
          <div class="opp-card ${valClass}" onclick="openDrawer('${String(o.id).replace(/'/g, "\\'")}')">
            <div class="d-flex justify-content-between mb-1">
              <span class="opp-ref">${o.ref || o.id}</span>
