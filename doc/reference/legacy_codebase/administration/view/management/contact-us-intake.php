...
<body>
 ...
 <nav class="sidebar">
  ...
  <div class="top-navbar">
    <div>
      <h5 class="mb-0 fw-bold text-dark">CONTACT EQUIRIES</h5>
      <small class="text-muted" style="font-size: 0.7rem;">Manage Enquiries from Website Contact us form</small>
    </div>
    ...
    <div class="offcanvas-body p-0 bg-white">
      ...
      <form id="enquiryForm" class="p-4">
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            <label class="form-label small fw-bold text-muted text-uppercase">Internal Notes (Admin Only)</label>
      ...
      <div class="p-4 border-top sticky-bottom bg-white d-flex justify-content-end gap-2">
        ...
        <button type="button" class="btn btn-smart-primary fw-bold d-none" onclick="saveStatus()">Save Updates</button>
      </div>
    </div>
  </div>
