...
$CURRENT_ROLE = $_SESSION['auth']['role'] ?? '';
...
<body>
 ...
 <nav class="sidebar">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="mgmt6" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
                <div class="sub-menu">
                    ...
                    <a href="smart-receivables-ledger.php" class="sub-link active">Smart Receivables Ledger (SRL)</a>
  ...
  <div class="top-navbar">
    <div>
      <h5 class="mb-0 fw-bold text-dark">Receivables Ledger</h5>
      <small class="text-muted" style="font-size: 0.7rem;">PAY INVOICES & MONITOR AGEING</small>
    </div>
        ...
        <div class="d-flex align-items-center gap-3">
          <div class="input-group input-group-sm" style="width: 320px;">
            ...
            <input
              ...
              class="form-control"
              id="searchInput"
              placeholder="Search Client, File Ref, Invoice #..."
  ...
  const CAN_EDIT = (CURRENT_ROLE === 'ADMIN' || CURRENT_ROLE === 'FINANCE');
</script>
  ...
  <script>
    ...
    function buildClientDatalist() {
      ...
      // Unique client names from ledger
      const names = Array.from(new Set(
        (LEDGER || [])
          .map(i => (i.client_name || '').trim())
          .filter(Boolean)
    ...
    // minimal HTML escape for safe option rendering
        ...
        data.forEach(inv => {
            ...
            if (CURRENT_TAB === 'AGEING') {
                ...
                tr.innerHTML = `
                    ...
                    <td class="text-end">
                        ${inv.balance > 0 && inv.status !== 'PAID'
                            ? `<button class="btn btn-sm btn-outline-primary d-none" onclick="openPayment(${inv.invoice_id}, '${inv.invoice_type}')"><i class="fa-solid fa-money-bill-wave"></i></button>`
                ...
                tr.innerHTML = `
                    ...
                    <td class="text-end">
                        ${!isPaid
                            ? `<button class="btn btn-sm btn-primary d-none" onclick="openPayment(${inv.invoice_id}, '${inv.invoice_type}')">Pay</button>`
