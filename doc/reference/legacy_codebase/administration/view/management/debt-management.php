        ...
        if ($action === 'search_files') {
            ...
            $sql = "
                ...
                LEFT JOIN client_master cm 
                    ON cm.client_id COLLATE utf8mb4_general_ci = ofm.client_id COLLATE utf8mb4_general_ci
                WHERE 
        ...
        if ($action === 'list_engagements') {
            ...
            $statusFilter = $_GET['status'] ?? 'ALL';
                ...
                $sql = "
                    ...
                    LEFT JOIN client_master cm 
                        ON cm.client_id COLLATE utf8mb4_general_ci = de.client_id COLLATE utf8mb4_general_ci
                    LEFT JOIN operations_file_master ofm 
                        ON ofm.operations_file_reference COLLATE utf8mb4_general_ci = de.operations_file_ref COLLATE utf8mb4_general_ci
        ...
        <div class="accordion-item border-0">
            ...
            <div id="mgmt6" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
                <div class="sub-menu">
                    ...
                    <a href="debt-management.php" class="sub-link active">Debt Management</a>
                </div>
            </div>
        </div>
    ...
    <div class="card-custom p-3 mb-4 bg-light border-0">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-md-4 text-end">
                ...
                <button class="btn btn-primary fw-bold shadow-sm bg-smart-blue border-0 d-none" onclick="openNewModal()"><i class="fa-solid fa-plus me-2"></i>New Engagement</button>
            </div>
        </div>
    </div>
    ...
    function renderTable(data) {
        ...
        data.forEach(r => {
            ...
            if(parseFloat(r.balance_due) > 0) {
                actBtns += `<button class="btn btn-sm btn-primary py-0 px-2 fw-bold d-none" onclick="openPay('${r.engagement_id}', ${r.balance_due})">Pay</button>`;
            } else {
            ...
            if(USER_ROLE === 'MANAGEMENT') {
                actBtns += ` <button class="btn btn-sm text-danger ms-2" onclick="deleteEng('${r.engagement_id}')"><i class="fa-solid fa-trash d-none"></i></button>`;
            }
