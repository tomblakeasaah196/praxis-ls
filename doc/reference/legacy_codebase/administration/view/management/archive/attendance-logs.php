    ...
    <div class="sidebar-menu accordion" id="adminMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin1" class="accordion-collapse collapse" data-bs-parent="#adminMenu">
                <div class="sub-menu">
                    ...
                    <a href="employee-master" class="sub-link">Employee Master Registry</a>
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin2" class="accordion-collapse collapse" data-bs-parent="#adminMenu">
                <div class="sub-menu">
                    <a href="contact-us-intake" class="sub-link">Contact Us Intake</a>
                    <a href="partnership-portal-intake" class="sub-link">Partnership Portal Intake</a>
                    <a href="market-campaign-registration" class="sub-link">Marketing Campaign Register</a>
                    <a href="sales-pipelining" class="sub-link">Sales Pipeline</a>
                    <a href="smart-quote-intake" class="sub-link">Smart Quote Intake</a>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin3" class="accordion-collapse collapse" data-bs-parent="#adminMenu">
                <div class="sub-menu">
                    <a href="margin-simulator-billing" class="sub-link">Margin Simulator & Pricing System</a>
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin4" class="accordion-collapse collapse" data-bs-parent="#adminMenu">
                <div class="sub-menu">
                    ...
                    <a href="transit-order" class="sub-link">Transit Order (OT)</a>
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin6" class="accordion-collapse collapse" data-bs-parent="#adminMenu">
                <div class="sub-menu">
                    ...
                    <a href="purchase-order" class="sub-link">Purchase Order</a>
                    <a href="proforma-invoice-portal" class="sub-link">Proforma Invoice Portal</a>
                    <a href="final-invoice" class="sub-link">Final Invoice System</a>
                    <a href="smart-receivables-ledger" class="sub-link">Smart Receivables Ledger (SRL)</a>
                    <a href="debt-management" class="sub-link">Debt Management</a>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item border-0">
            ...
            <div id="admin7" class="accordion-collapse collapse" data-bs-parent="#adminMenu">
                <div class="sub-menu">
                    <a href="user-role-management" class="sub-link">User & Role Management (IAM)</a>
                    <a href="payroll-management" class="sub-link">Payroll Management</a>
                    <a href="attendance-logs" class="sub-link">Attendance & Time Logging</a>
