...
// --- Display values ---
$fullName  = trim((string)($me['full_name'] ?? 'MANAGEMENT'));
  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="mgmtMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="mgmt3" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
                <div class="sub-menu">
  ...
  <div class="main-content px-4 pb-5">
    ...
    <div class="row py-4 align-items-center">
      ...
      <div class="col-md-6 text-end">
        <button class="btn btn-dark fw-bold px-4 py-2 shadow-sm d-none" type="button" onclick="openSim('new')">
