 ...
 <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="mgmtMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="mgmt4" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
                <div class="sub-menu">
                    ...
                    <a href="operational-milestone-tracking.php" class="sub-link active">Operational Milestone Tracking</a>
  ...
  return alert("View-only mode: updates are disabled.");
  
  // existing code below will never run
}
