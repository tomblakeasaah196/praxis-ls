...
require_role(['MANAGEMENT']); // keep as-is (you can widen later if needed)
  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="mgmtMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="mgmt1" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
                <div class="sub-menu">
                    <a href="client-master-registry.php" class="sub-link active">Client Master Registry</a>
