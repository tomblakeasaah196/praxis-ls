...
<body>
  ...
  <div class="top-navbar">
    <div>
      <h5 class="mb-0 fw-bold text-dark">Operational Cost Reconciliation</h5>
        <small class="text-muted" style="font-size: 0.7rem;">OCR REGISTER & VALIDATION WORKFLOW</small>
...
let CURRENT_ROLE = 'OPERATINS'; // OPS | FIN | MGMT
...
function renderButtons(){
  ...
  else if (CURRENT_ROLE === 'FININANCE') {
    if (!currentOCR){
      footerMsg.innerText = "Select an OCR record.";
      return;
    }
