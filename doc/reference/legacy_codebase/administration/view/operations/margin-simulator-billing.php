  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="salesMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="sales4" class="accordion-collapse collapse show" data-bs-parent="#salesMenu">
                <div class="sub-menu">
  ...
  ${
    ...
    ? `
      <input
        ...
        ${disabled}
      >
      <div id="code-display-${i}" class="text-muted font-mono mt-1" style="font-size:0.7rem">
        ${escapeHtml(l.code || '')}
      </div>
    `
    : `
