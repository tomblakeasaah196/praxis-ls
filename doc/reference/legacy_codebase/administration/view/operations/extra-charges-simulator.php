   ...
   <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="opsMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="ops2" class="accordion-collapse collapse show" data-bs-parent="#opsMenu">
                <div class="sub-menu">
                    <a href="extra-charges-simulator" class="sub-link active">Extra Charges Simulator</a>
                </div>
            </div>
        </div>
