...
";
  ...
  if ($ajax === 'pr_save') {
    ...
    try {
      ...
      $conn->commit();
// FIX: Return amount_total so frontend ACTIVE state can update immediately
json_exit(['ok' => true, 'data' => ['pr_id' => $prId, 'amount_total' => $amountTotal]]);
    ...
    <div class="sidebar-menu accordion" id="opsMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="ops6" class="accordion-collapse collapse" data-bs-parent="#opsMenu">
                <div class="sub-menu">
                    <a href="cash-request" class="sub-link active">Cash Request</a>
                </div>
            </div>
        </div>
...
try {
    ...
    // FIX: Update the global total immediately after save
    ACTIVE.amount_total = Number(res.amount_total); 
