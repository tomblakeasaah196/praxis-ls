...
<body>
  ...
  <script>
    ...
    function switchRole(role) {
      ...
      if (hint) {
        hint.innerText = role === 'OPERATIONS' ? 'Logged as Operations' : (role === 'FIN' ? 'Logged as Finance' : 'View Only');
      }
      if (btnNew) {
        btnNew.style.display = (role === 'OPERATIONS') ? 'block' : 'none';
      }
