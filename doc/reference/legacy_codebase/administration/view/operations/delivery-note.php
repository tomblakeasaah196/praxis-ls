...
require_role(['ADMIN','OPERATIONS','SALES', 'MANAGEMENT','FINANCE']);
  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="opsMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="ops4" class="accordion-collapse collapse show" data-bs-parent="#opsMenu">
                <div class="sub-menu">
                    <a href="delivery-note" class="sub-link active">Delivery Note</a>
                </div>
            </div>
        </div>
