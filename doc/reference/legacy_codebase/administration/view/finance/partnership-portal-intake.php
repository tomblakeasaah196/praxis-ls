...
<body>
  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="financeMenu">
        ...
        <div class="accordion-item border-0">
            ...
            <div id="fin2" class="accordion-collapse collapse show" data-bs-parent="#financeMenu">
                <div class="sub-menu">
                    <a href="partnership-portal-intake.php" class="sub-link active">Partnership Portal Intake</a>
                </div>
            </div>
        </div>
  ...
  <div class="top-navbar">
    <div>
      <h5 class="mb-0 fw-bold text-dark">Partnership Portal Intake</h5>
      <small class="text-muted" style="font-size: 0.7rem;">AGENCY PROPOSALS & VENDOR REGISTRATION</small>
    </div>
