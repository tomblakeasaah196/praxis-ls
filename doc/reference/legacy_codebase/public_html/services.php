<?php
  ...
  $canonicalUrl = "https://smartls.cm/services"; // update to your real domain
          ...
          <div class="service-page__panel">
            <div class="service-page__panel-inner">
              ...
              <div class="service-page__pill-row" role="group" aria-label="Freight modes" data-i18n-html="services_a_modes_aria">
                <a class="service-page__mode-btn" href="air-freight" data-i18n="services_a_mode_air">Air</a>
                <a class="service-page__mode-btn" href="land-freight" data-i18n="services_a_mode_land">Land</a>
                <a class="service-page__mode-btn" href="sea-freight" data-i18n="services_a_mode_sea">Sea</a>
              </div>
