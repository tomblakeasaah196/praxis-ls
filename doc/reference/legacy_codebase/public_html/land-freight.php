<?php
  ...
  $canonicalUrl = "https://smartls.cm/land-freight"; // update to exact public URL
    ...
    <div class="container">
      <div class="freight-lp__reader card-premium p-4 p-lg-5" data-reveal>
        ...
        <div class="freight-lp__cta mt-4 pt-3">
          <a class="btn btn-smart btn-lg px-4" href="smart-quote?service=land" data-i18n="landfreight_cta">
