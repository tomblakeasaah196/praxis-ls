<?php
  ...
  $canonicalUrl = "https://smartls.cm/about"; // update to real domain
    ...
    <div class="container">
      <div class="row g-4 align-items-end">
        ...
        <div class="col-lg-3 text-lg-end" data-reveal>
          <a class="btn btn-smart px-4" href="index#contact_entry">
        ...
        <div class="col-lg-7" data-reveal>
          <div class="about-page__panel card-premium p-4 p-lg-5 h-100">
            ...
            <p class="about-page__p mb-0" data-i18n="about_overview_body">
              Founded in 2021, Smart Logistics &amp; Services Ltd has expanded rapidly from Customs Brokerage to a full-service 3PL provider. Based in Douala, we serve as the gateway to the CEMAC region.
            </p>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6" data-reveal>
          <div class="about-page__card card-premium p-4 p-lg-5 h-100">
            ...
            <p class="about-page__p" data-i18n="about_mission_body">
             Our mission is to revolutionize the logistics landscape by delivering solutions that not only meet but exceed our customers’ expectations. We strive to create an environment that ignites passion, fuels creativity, and inspires our team to provide unparalleled customer experiences. With unwavering commitment, we navigate towards a future where excellence is the standard, and innovation is the driving force. Our legacy will be built on the foundations of reliability, flexibility, and customer satisfaction, setting a new benchmark for the industry.
            </p>
            ...
            <p class="about-page__p mb-0" data-i18n="about_vision_body">
              Our vision is to reign supreme as the logistics leaders of choice, setting the gold standard for excellence in Cameroon and the CEMAC subregion. We aspire to be the benchmark against which all others are measured, renowned for delivering unparalleled experiences to our cherished customers.
            </p>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-6" data-reveal>
          <div class="about-page__card card-premium p-4 p-lg-5 h-100">
            ...
            <div class="about-page__li">
                <span class="dot"></span>
                <span class="txt" >
                  <b data-i18n="about_operational_guide">Our Guiding Principles:</b>
<p
 data-i18n="about_operational_guide_body">Customer Delight, Team Empowerment and Excellence</p></span>
              </div>
          </div>
        </div>
        ...
        <div class="col-lg-8" data-reveal>
          <article class="about-page__letter card-premium p-4 p-lg-5 h-100">
            ...
            <p class="about-page__p" data-i18n="about_ceo_p1">
              At SMART LOGISTICS AND SERVICES LTD, we view logistics as a strategic driver of trade, growth, and competitiveness. Our responsibility goes beyond moving cargo. It is about delivering control, visibility, and reliable execution in complex operating environments.
            </p>
        ...
        <div class="col-12 col-lg-4" data-reveal>
          <div class="about-page__card about-page__card--esg about-page__card--env h-100">
            ...
            <p class="about-page__p" data-i18n="about_esg_env_p">
              SMART LOGISTICS AND SERVICES LTD integrates environmentally responsible practices across its operations to reduce emissions, minimize waste, and optimize resource usage throughout the supply chain.
            </p>
    ...
    <div class="container" data-reveal>
      <div class="about-page__cta-shell card-premium p-4 p-lg-5">
        <div class="row g-3 align-items-center">
          <div class="col-lg-8">
            <div class="about-page__cta-title" data-i18n="about_cta_title">Need a new and unique experience from a logistics partner? Try US</div>
          </div>
          <div class="col-lg-4 text-lg-end">
            <a class="btn btn-smart px-4" href="index.php#contact_entry">
              <i class="fa-solid fa-envelope me-2"></i> <span data-i18n="about_cta_btn">Contact Us</span>
            </a>
          </div>
        </div>
      </div>
