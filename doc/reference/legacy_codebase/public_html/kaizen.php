<?php
  ...
  $canonicalUrl = "https://smartls.cm/kaizen"; // update to exact public URL
    ...
    <div class="container">
      ...
      <div class="row g-3">
        ...
        <div
          ...
          data-reveal
        >
          <a class="kaizen-page__card" href="kaizen-article?slug=unlocking-the-power-of-logistics">
            ...
            <div class="kaizen-page__body">
              ...
              <div class="kaizen-page__meta">
                <span>
                  ...
                  <span data-i18n="kaizen_by_prefix_article">By
                  Joseph MOUKOKO</span> 
                </span>
              </div>
        ...
        <div
          ...
          data-reveal
        >
          <a class="kaizen-page__card" href="kaizen-article?slug=the-role-of-local-logistics">
            ...
            <div class="kaizen-page__body">
              ...
              <div class="kaizen-page__meta">
                <span>
                  <i class="fa-solid fa-user me-2" style="color:var(--smart-orange)"></i>
                  <span data-i18n="kaizen_by_prefix">By
                  Timothee MASSOMBA,  </span>
                </span>
              </div>
        ...
        <div
          ...
          data-reveal
        >
          <a class="kaizen-page__card" href="kaizen-article?slug=demurrage-detention-storage">
            ...
            <div class="kaizen-page__body">
              ...
              <div class="kaizen-page__meta">
                <i class="fa-solid fa-user me-2" style="color:var(--smart-orange)"></i>
                <span data-i18n="kaizen_a3_author">By Aurelie KUIKEU</span>
              </div>
        ...
        <div
          ...
          data-reveal
        >
          <a class="kaizen-page__card" href="kaizen-article?slug=smart-integration-case-study">
            ...
            <div class="kaizen-page__body">
              ...
              <div class="kaizen-page__meta">
                <i class="fa-solid fa-user me-2" style="color:var(--smart-orange)"></i>
                <span data-i18n="kaizen_a4_author">By Marie MANOUMA</span>
              </div>
        ...
        <div
          ...
          data-reveal
        >
          <a class="kaizen-page__card" href="kaizen-article?slug=green-logistics-cemac">
            ...
            <div class="kaizen-page__body">
              ...
              <div class="kaizen-page__meta">
                <i class="fa-solid fa-user me-2" style="color:var(--smart-orange)"></i>
                <span data-i18n="kaizen_a5_author">By Victor ETADUOVIE</span>
              </div>
