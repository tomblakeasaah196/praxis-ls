<?php
  ...
  if (!$exists) {
    ...
    $canonicalUrl = "https://smartls.cm/kaizen-article.php?slug=" . urlencode($slug);
  ...
  <section class="kaizen-page__article-hero">
    <div class="container">
      <div class="kaizen-page__article-shell card-premium p-4 p-lg-5" data-reveal>
        ...
        <a href="kaizen.php" class="btn btn-smart" data-i18n="kaizen_not_found_cta">Back to Kaizen Hub</a>
      </div>
    </div>
  </section>
      ...
      <div class="row g-4 align-items-end">
        <div class="col-lg-10">
          <div class="kaizen-page__crumbs" data-reveal>
            <a href="kaizen.php" data-i18n="kaizen_crumb_hub">Kaizen Hub</a>
            <span class="sep">/</span>
        ...
        <div class="col-lg-2 text-lg-end" data-reveal>
          <a href="kaizen.php#articles" class="btn btn-smart btn-sm px-3 py-2" data-i18n="kaizen_back_to_hub">Back to Hub</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row justify-content-center">
        <div class="col-12">
          ...
          <div class="kaizen-page__nextprev d-flex gap-3 mt-4" data-reveal>
            <?php if ($prevSlug): ?>
              <a class="kaizen-page__navcard" href="kaizen-article.php?slug=<?php echo urlencode($prevSlug); ?>">
            ...
            <?php if ($nextSlug): ?>
              <a class="kaizen-page__navcard ms-auto" href="kaizen-article.php?slug=<?php echo urlencode($nextSlug); ?>">
