    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-lg-2" aria-label="Footer quick links">
        ...
        <ul class="list-unstyled small mb-0" role="list">
          ...
          <li class="mb-2">
            <a class="footer-link" href="<?php echo $homePrefix; ?>#portfolio" data-i18n="footer_quick_portfolio">Portfolio</a>
          </li>
          <li>
      ...
      <!-- Newsletter -->
      <div class="col-lg-3" aria-label="Newsletter subscription">
        <h3 class="h6 mb-3" style="font-weight:700;" data-i18n="footer_newsletter_title">Subscribe to our Newsletter</h3>
        <form class="d-flex gap-2" onsubmit="return false;" aria-label="Newsletter form">
          ...
          <input
            ...
            data-i18n-placeholder="footer_newsletter_email_ph"
            autocomplete="email"
            inputmode="email"
            aria-label="Email address"
          >
          <button class="btn btn-smart btn-sm" type="button" data-i18n="footer_newsletter_btn">Subscribe</button>
        </form>
        <div class="small mt-2" style="color: rgba(255,255,255,.55);">
        </div>
        <div class="" aria-label="Corporate policies">
  <h3 class="h6 mb-3 fw-bold">Corporate Policies</h3>
      ...
      <div class="col-lg-3" aria-label="Footer contact information">
        ...
        <ul class="list-unstyled small mb-3" style="color: rgba(255,255,255,.72);" role="list">
          ...
          <li class="mb-2">
            ...
            <a class="footer-link" href="tel:+237233420281">+237 233 420 281</a>
          </li>
          <li>
