...
if (!empty($_SESSION['auth']['user_id'])) {
  ...
  // Strict fallback: choose one of your valid modules, not dashboard
...
<head>
  ...
  <style>
    ...
    .brand-mark {
      ...
      box-shadow:0 8px 26px rgba(238,125,4,0.18);
    }
...
<body>
  ...
  <div id="login-screen" aria-hidden="false">
    <div class="login-card">
      ...
      <form class="p-4" id="login-form" onsubmit="event.preventDefault(); attemptLogin();">
        <input type="hidden" id="csrf_token" value="<?php echo htmlspecialchars($token); ?>">

        <div id="alertBox" class="alert d-none mx-4 mt-3" role="alert"></div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input id="login-user" class="form-control smart-input" type="text" placeholder="Enter username or email" style="border-left:0;" autocomplete="username">
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input id="login-pass" class="form-control smart-input" type="password" placeholder="••••••••" style="border-left:0;" autocomplete="current-password">
          </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 small">
          ...
          <a href="forgot-password.php" class="text-decoration-none" style="color:var(--smartBlue)">Forgot Password?</a>
        </div>
  ...
  <script>
    function showAlert(type, msg){
      ...
      alertBox.className = `alert alert-${type} mx-4 mt-3`;
    ...
    async function attemptLogin(){
      ...
      if (!identifier || !password) {
        showAlert('danger', 'Please enter username/email and password.');
        return;
      }
