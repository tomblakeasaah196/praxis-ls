            ...
            <div class="accordion-item border-0">
                ...
                <div id="menu2" class="accordion-collapse collapse show" data-bs-parent="#salesMenu">
                    <div class="sub-menu">
                        ...
                        <a href="partnership-portal-intake.php" class="sub-link active">Partnership Portal</a>
                    </div>
                </div>
            </div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="partnerDrawer" style="width: 750px;">
    ...
    <div class="offcanvas-body p-0 bg-white">
      ...
      <form id="partnerForm" class="p-4">
        ...
        <h6 class="text-uppercase small fw-bold text-muted border-bottom pb-2 mb-3">Sales Actions</h6>
        <div class="row g-3">
          <div class="col-md-6">
