  ...
  <nav class="sidebar">
        ...
        <div class="sidebar-menu accordion" id="salesMenu">
            <div class="accordion-item border-0">
                ...
                <div id="menu1" class="accordion-collapse collapse" data-bs-parent="#salesMenu">
                    <div class="sub-menu">
            ...
            <div class="accordion-item border-0">
                ...
                <div id="menu3" class="accordion-collapse collapse show" data-bs-parent="#salesMenu">
                    <div class="sub-menu">
                        <a href="market-campaign-registration.php" class="sub-link active">Marketing Campaigns</a>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="campaignDrawer" style="width: 800px;">
    ...
    <div class="offcanvas-body p-0 bg-white">
      <form id="campaignForm" class="p-4">
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-4">
            ...
            <div class="input-group">
              <input type="number" class="form-control smart-input" id="dBudget" oninput="calculateCalculatedMetrics()">
          ...
          <div class="row g-3 text-center">
            <div class="col-4">
              <div class="bg-white p-2 rounded border">
                ...
                <input type="number" class="form-control smart-input text-center fw-bold text-dark fs-5" id="dLeads" value="0" oninput="calculateCalculatedMetrics()">
              </div>
            </div>
            <div class="col-4">
              <div class="bg-white p-2 rounded border">
                <label class="small fw-bold text-muted mb-1">Opportunities</label>
                <input type="number" class="form-control smart-input text-center fw-bold text-primary fs-5" id="dOps" value="0" oninput="calculateCalculatedMetrics()">
              </div>
            </div>
            <div class="col-4">
              <div class="bg-white p-2 rounded border">
                <label class="small fw-bold text-muted mb-1">Conversions Won</label>
                <input type="number" class="form-control smart-input text-center fw-bold text-success fs-5" id="dWon" value="0" oninput="calculateCalculatedMetrics()">
              </div>
            </div>
      ...
      <div class="p-4 border-top sticky-bottom bg-white d-flex justify-content-end gap-2">
        ...
        <button type="button" class="btn btn-smart-primary fw-bold" onclick="saveCampaign()">Save Campaign</button>
      </div>
    </div>
  </div>
