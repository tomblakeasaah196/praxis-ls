...
<head>
  ...
  <style>
    ...
    .btn-smart-orange:hover { filter: brightness(0.95); }
  </style>
</head>
<body>
        ...
        <div class="sidebar-menu accordion" id="salesMenu">
            <div class="accordion-item border-0">
                ...
                <div id="menu1" class="accordion-collapse collapse" data-bs-parent="#salesMenu">
                    <div class="sub-menu">
                        <a href="index.php" class="sub-link  ">Dashboards & KPI</a>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item border-0">
                ...
                <div id="menu3" class="accordion-collapse collapse show" data-bs-parent="#salesMenu">
                    <div class="sub-menu">
                        ...
                        <a href="sales-pipelining.php" class="sub-link active">Opportunity Tracking</a>
                    </div>
                </div>
            </div>
  ...
  async function openDrawer(id) {
    ...
    try {
      ...
      document.getElementById('drawerId').innerText =
        (opp.public_quote_ref || opp.quote_request_id);
