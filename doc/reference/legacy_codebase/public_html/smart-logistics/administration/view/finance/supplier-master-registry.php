...
require_role(['FINANCE']); // keep same guard as index.php (change if supplier page allows more roles)
  ...
  <nav class="sidebar">
        ...
        <div class="sidebar-menu accordion" id="financeMenu">
            ...
            <div class="accordion-item border-0">
                ...
                <div id="menu2" class="accordion-collapse collapse show" data-bs-parent="#financeMenu">
                    <div class="sub-menu">
                       <a href="attendance-logs.php" class="sub-link">Attendance Logs</a>
                        ...
                        <a href="supplier-master-registry.php" class="sub-link active">Supplier Master</a>
