    ...
    <div class="sidebar-menu accordion" id="mgmtMenu">
      <div class="accordion-item border-0">
        ...
        <div id="menu1" class="accordion-collapse collapse" data-bs-parent="#mgmtMenu">
          <div class="sub-menu">
            <a href="#" class="sub-link fw-bold ">Dashboards & KPI Reporting</a>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item border-0">
        ...
        <div id="menu4" class="accordion-collapse collapse show" data-bs-parent="#mgmtMenu">
          <div class="sub-menu">
            <a href="#" class="sub-link">Sales Pipeline / Opportunity Tracking</a>
            ...
            <a href="contact-us-intake.php" class="sub-link active">Contact Us Intake</a>
    ...
    <div class="offcanvas-body p-0 bg-white">
      ...
      <form id="enquiryForm" class="p-4">
        ...
        <div class="row g-3">
          ...
          <div class="col-12">
            <label class="form-label small fw-bold text-muted text-uppercase">Internal Notes (Management Only)</label>
            <textarea class="form-control smart-input" id="dNotes" rows="3" placeholder="Add internal remarks here..." readonly></textarea>
          </div>
        </div>
      </form>
      ...
      return `
        <tr>
          ...
          <td class="text-end pe-4">
            <button onclick="openDrawer('${escapeAttr(e.enquiry_id)}')" class="btn btn-sm btn-outline-dark fw-bold">View</button>
          </td>
        </tr>
      `;
    }).join('');
