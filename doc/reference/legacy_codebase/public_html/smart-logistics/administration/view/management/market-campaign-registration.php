...
<body>
  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="mgmtMenu">
      ...
      <div class="accordion-item border-0">
        <button class="menu-btn" type="button" data-bs-toggle="collapse show" data-bs-target="#menu4">
      ...
      return `
        <tr>
          ...
          <td class="text-end pe-4">
            <button onclick="openDrawer('edit', '${c.id}')" class="btn btn-sm btn-outline-dark fw-bold">View</button>
          </td>
        </tr>
      `;
    }).join('');
