...
<body>
  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="adminMenu">
      ...
      <div class="accordion-item border-0">
        <button class="menu-btn active" type="button" data-bs-toggle="collapse" data-bs-target="#menu5" aria-expanded="true">
        ...
        <div id="menu5" class="accordion-collapse collapse show" data-bs-parent="#adminMenu">
          <div class="sub-menu">
            ...
            <a href="transit-order.php" class="sub-link active">Transit Orders</a>
  ...
  <div class="main-content px-4 pb-5">
    <div class="row py-4 align-items-center">
      ...
      <div class="col-md-6 text-end">
        <button class="btn btn-dark fw-bold shadow-sm px-4" onclick="window.print()">
        ...
        <div class="card-custom h-100">
          ...
          <div class="mb-4">
            ...
            <div class="input-group">
              ...
              <input type="text" id="inp-ot-num" class="form-control smart-input fw-bold" value="00100" readonly>
            </div>
          </div>
  ...
  <div id="print-area">
    <div class="doc-header">
      ...
      <div style="text-align: right;">
        <div style="font-size: 14px; font-weight: bold;">No. <span id="p-ot-num">SLAS/OT/00100</span></div>
