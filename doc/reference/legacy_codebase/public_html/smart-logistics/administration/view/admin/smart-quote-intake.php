  ...
  <nav class="sidebar">
    ...
    <div class="sidebar-menu accordion" id="adminMenu">
      ...
      <div class="accordion-item border-0">
        ...
        <!-- keep this one OPEN so the current page is visible -->
        <div id="menu4" class="accordion-collapse collapse show" data-bs-parent="#adminMenu">
          <div class="sub-menu">
            <a href="smart-quote-intake.php" class="sub-link active" aria-current="page">Smart Quote Intake</a>
    ...
    <div class="sidebar-footer">
      <button class="btn btn-outline-danger w-100 btn-sm fw-bold" onclick="location.href='../../api/auth/logout.php'">
