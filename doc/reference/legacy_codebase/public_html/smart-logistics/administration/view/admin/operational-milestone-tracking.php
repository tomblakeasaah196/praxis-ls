...
<body>
      ...
      <div class="accordion-item border-0">
        ...
        <div id="menu5" class="accordion-collapse collapse show" data-bs-parent="#adminMenu">
          <div class="sub-menu">
            ...
            <a href="operational-milestone-tracking.php" class="sub-link active">Milestone Tracking</a>
  ...
  <div class="top-navbar">
    <div>
      <h5 class="mb-0 fw-bold text-dark">Operations Exec</h5>
      <small class="text-muted" style="font-size: 0.7rem;">OPERATIONAL MILESTONE TRACKING</small>
    </div>
  ...
  <script>
    ...
    async function refreshFiles(){
      ...
      files = (rows || []).map(r => {
        ...
        const client = r.client_bill_to || r.client_id || '—';
          ...
          <div class="timeline-item d-flex gap-3" style="${cursorStyle}" ${isClickable ? `onclick='selectStage(${idx})'` : ''}>
            ...
            <div class="pt-2 flex-grow-1">
              <div class="small fw-bold text-uppercase ${status === 'pending' ? 'text-muted' : 'text-dark'}" style="letter-spacing:.06em;">
                ${escapeHtml(m.stage_name || ('Stage ' + (idx+1)))}
              </div>
              ${dueInfo}
              ${completedInfo}
