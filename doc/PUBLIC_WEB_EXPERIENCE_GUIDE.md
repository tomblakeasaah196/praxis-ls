...
| PR 2 | **Complete — in review** | on merge of this PR | **41%** | 19 of 24 points. §6.3 (asset upload), §6.4 (announcements UI + public read) and §6.8 (entity story tab) are **not built** and are carried — see §3.3. Six findings, four of them defects in this guide's own spec. |
| PR 3 | Not started | — | — | — |
| PR 4 | Not started | — | — | — |
| PR 5 | Not started | — | — | — |
