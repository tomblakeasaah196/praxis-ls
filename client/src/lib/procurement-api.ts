...
/* ── Purchase requests (MOD-62, /purchase-requests) ── */
...
/* ── Purchase orders (MOD-60, /purchase-orders) ── */
...
/* ── Goods received / GRN (MOD-61, /goods-received) ── */
...
/* ── Supplier invoices (MOD-61, /supplier-invoices) ── */
