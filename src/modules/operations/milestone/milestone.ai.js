...
module.exports = {
  ...
  reads: [
    ...
    { key: "dossier_milestones", service: service.listByDossier, describe: "List a dossier's milestone instances, with baseline / planned / forecast dates, health and delay attribution." },
    { key: "service_type_assumptions", service: (c, p) => service.listAssumptions(c, (p && p.service_type_id) || p), describe: "The published scheduling assumptions for a service type (counterparty hours, free time, force-majeure exclusions)." },
  ],
  writes: [
