...
module.exports = {
  ...
  writes: [{ key: "record_cost", service: service.recordCost, schema: validator.schemas.record, permission: { module: "MOD-47", action: "create" }, confirm: true, describe: "Record an actual operations file cost and post it to the ledger (débours→4731). KB §6.7." }],
};
