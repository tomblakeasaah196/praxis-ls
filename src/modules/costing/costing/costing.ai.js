...
module.exports = {
  ...
  writes: [
    { key: "create_costing", service: service.createDraft, schema: validator.schemas.create, permission: { module: "MOD-46", action: "create" }, confirm: true, describe: "Create a DRAFT dossier costing (budget HT/VAT/TTC; débours pass-through §6.7 — no margin, §2.2)." },
